...
int main()
{
  ...
  StdCoutLogger logger_cout(main_tree);
  FileLogger logger_file(main_tree, "bt_trace.fbl");
...
//   StdCoutLogger logger_cout(subA_tree);
//   FileLogger logger_file(subA_tree, "bt_trace.fbl");
